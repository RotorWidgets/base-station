...
from base_station.api.fields import StraightJSONField
from base_station.events.models import Location, Event, Occurrence
...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = ('id', 'resource_uri', 'title', 'description', 'recurrences',)
