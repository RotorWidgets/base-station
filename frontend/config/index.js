// A lot of the initial build code is based off of:
...
config.set('proxy', process.env.PROXY || 'http://localhost:8000')
...
// get all the non-dev dependencies for use with building front-end libs bundle
