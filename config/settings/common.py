# -*- coding: utf-8 -*-
"""
Django settings for base_station project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'base_station.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'base_station.users.adapter.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'base_station.users.adapter.SocialAccountAdapter'
